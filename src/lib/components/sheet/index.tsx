...
const Root = (props: SheetProps) => {
	return <SheetPrimitive.Root data-slot="sheet" {...props} />;
};

const Trigger = (props: SheetTriggerProps) => {
	return <SheetPrimitive.Trigger data-slot="sheet-trigger" {...props} />;
};

const Close = (props: SheetCloseProps) => {
...
const Overlay = ({ className, ...props }: SheetOverlayProps) => {
	return (
...
const Title = ({ className, ...props }: SheetTitleProps) => {
	return (
...
const Description = ({ className, ...props }: SheetDescriptionProps) => {
	return (
